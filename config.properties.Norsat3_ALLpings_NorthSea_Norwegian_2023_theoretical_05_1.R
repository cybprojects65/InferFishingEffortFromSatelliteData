...
output_analysis="./results/Effort_NorSat3_ALLdata_NorthSea_NorwegianSea_2023_theoretical_abundance.csv"
##ANALYSIS
resolution=0.5
...
fraction_of_abundance_observation_lower_bound=0.5
#Expected 75perc of ratio between AIS data and all data:  GFW: 1 NSAT3: 0.53
fraction_of_abundance_observation_upper_bound=1
